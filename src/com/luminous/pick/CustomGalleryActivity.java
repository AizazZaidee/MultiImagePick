...
public class CustomGalleryActivity extends Activity {
	...
	private int maxImageAllowedForSelection = 9;
	...
	private void initImageLoader() {
		try {
			...
			ImageLoaderConfiguration.Builder builder = new ImageLoaderConfiguration.Builder(getBaseContext()).defaultDisplayImageOptions(defaultOptions).discCache(new UnlimitedDiscCache(cacheDir))
	...
	AdapterView.OnItemClickListener mItemMulClickListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> l, View v, int position, long id) {
			if (adapter.getSelected().size() >= maxImageAllowedForSelection) {
